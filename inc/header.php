    ...
    <div class="container_12">
        ...
        <div class="grid_12">
            <ul class="nav main">
				...
				<li class="ic-charts"><a href="./contrat.php"><span>Contrat</span></a></li>
                <li class="ic-grid-tables"><a href="./parc.php"><span>Parc informatique</span></a></li>
                <li class="ic-gallery dd"><a href="./site.php"><span>Site Internet</span></a></li>
                <li class="ic-notifications"><a href="javascript:"><span>Parametrage</span></a>
                    <ul>
